...
$items = "select * from up where category='".$product."'";
$result = $conn->query($items);
$sum = "select SUM(value) as totalCost from up where category='".$product."'";
        ...
        <div id="items" style="border-top:1px solid #dcdcdc" class="shopify-section shopify-section--bordered">
            <section class="Section Section--spacingNormal">
                <header class="SectionHeader SectionHeader--center">
                    <div class="Container">
                        <h2 style="text-transform:uppercase" class="SectionHeader__Heading Heading u-h1"><u><?php echo $product." - Value of Rs.".$totalCost->totalCost; ?></u></h2>
                    </div>
                </header>
