        ...
        <div id="items" style="border-top:1px solid #dcdcdc" class="shopify-section shopify-section--bordered">
            <section class="Section Section--spacingNormal">
                <header class="SectionHeader SectionHeader--center">
                    <div class="Container">
                        <h2 style="text-transform:uppercase" class="SectionHeader__Heading Heading u-h1">SUMMARY</h2>
                    </div>
                </header>
                <div class="TabPanel" aria-hidden="false">
                    <div class="ProductListWrapper Container">
                        ...
                        $overview = "SELECT DISTINCT(onCharge) AS OnCharge, SUM(value) AS totalCost, COUNT(item) AS itemNos, COUNT(category) AS categories, COUNT(itemCondition) AS Svc FROM up WHERE itemCondition='Svc' GROUP BY onCharge";
                        ...
                        if($result->num_rows > 0)
                        {
                            ...
                            while($row = $result->fetch_assoc())
                            {
                                ...
                                ?>
                                    <tr>
                                    <td scope="row">
                                        <a href="onChargeDetails.php?onCharge=<?= $row['OnCharge']?>" target="_blank">
                                        <b><?php echo $row['OnCharge']; ?></b></td>
                                        </a>
